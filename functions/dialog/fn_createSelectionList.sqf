...
private _buttonCar = _display ctrlCreate ["RscButtonArsenal",-1,_cgLeft];
...
private _buttonTracked = _display ctrlCreate ["RscButtonArsenal",-1,_cgLeft];
...
private _buttonHeli = _display ctrlCreate ["RscButtonArsenal",-1,_cgLeft];
...
private _buttonPlane = _display ctrlCreate ["RscButtonArsenal",-1,_cgLeft];
...
private _buttonBoat = _display ctrlCreate ["RscButtonArsenal",-1,_cgLeft];
